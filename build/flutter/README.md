...
* `proyecto_cepav` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `Proyecto-Cepav` - executable or bundle name on disk.
* `Proyecto-Cepav` - display name shown in window titles and about app dialogs.
